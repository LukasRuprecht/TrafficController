...
SIGNAL ww_sm_clken_wv : std_logic;
SIGNAL ww_blink_sig_wv : std_logic;
...
SIGNAL \sm_clken_wv~output_o\ : std_logic;
SIGNAL \blink_sig_wv~output_o\ : std_logic;
...
SIGNAL \INST8|NS_A~0_combout\ : std_logic;
...
SIGNAL \INST8|EW_A~combout\ : std_logic;
...
SIGNAL \INST8|ALT_INV_NS_A~0_combout\ : std_logic;
...
ww_sw <= sw;
leds <= ww_leds;
sm_clken_wv <= ww_sm_clken_wv;
blink_sig_wv <= ww_blink_sig_wv;
EW_a <= ww_EW_a;
EW_g <= ww_EW_g;
EW_d <= ww_EW_d;
NS_a <= ww_NS_a;
...
\INST8|ALT_INV_NS_A~0_combout\ <= NOT \INST8|NS_A~0_combout\;
...
\sm_clken_wv~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
PORT MAP (
	...
	devoe => ww_devoe,
	o => \sm_clken_wv~output_o\);

\blink_sig_wv~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
-- pragma translate_on
PORT MAP (
	i => \INST8|ALT_INV_NS_A~0_combout\,
	devoe => ww_devoe,
	o => \NS_g~output_o\);
...
-- Equation(s):
-- \INST5|sm_clken~combout\ = LCELL((\INST5|clk_reg_extend\(0) & !\INST5|clk_reg_extend\(1)))
...
-- Equation(s):
-- \INST8|current_state~31_combout\ = (\INST8|current_state.S14~q\ & !\INST2|sreg\(1))
...
-- Equation(s):
-- \INST8|current_state~26_combout\ = (!\INST8|current_state.S15~q\ & !\INST2|sreg\(1))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST8|current_state.S15~q\,
	datab => \INST2|sreg\(1),
...
-- Equation(s):
-- \INST8|current_state~20_combout\ = (!\INST6|sreg~q\ & (!\INST2|sreg\(1) & \INST8|current_state.S1~q\))
...
-- Equation(s):
-- \INST8|Selector0~0_combout\ = (\INST8|current_state.S5~q\) # ((\INST6|sreg~q\ & \INST8|current_state.S1~q\))
...
-- Equation(s):
-- \INST8|current_state~29_combout\ = (\INST8|current_state.S8~q\ & !\INST2|sreg\(1))
...
-- Equation(s):
-- \INST8|current_state~24_combout\ = (!\INST7|sreg~q\ & (!\INST2|sreg\(1) & \INST8|current_state.S9~q\))
...
-- Equation(s):
-- \INST8|Selector1~0_combout\ = (\INST8|current_state.S13~q\) # ((\INST7|sreg~q\ & \INST8|current_state.S9~q\))
...
\INST8|NS_A~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST8|NS_A~0_combout\ = (!\INST8|current_state.S6~q\ & !\INST8|current_state.S7~q\)
...
PORT MAP (
	...
	combout => \INST8|NS_A~0_combout\);

\INST9|DOUT_TEMP[6]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST9|DOUT_TEMP[6]~0_combout\ = (\INST9|clk_proc:COUNT[10]~q\ & (((!\INST8|NS_A~0_combout\)))) # (!\INST9|clk_proc:COUNT[10]~q\ & ((\INST8|current_state.S14~q\) # ((\INST8|current_state.S15~q\))))
...
PORT MAP (
	...
	datad => \INST8|NS_A~0_combout\,
	combout => \INST9|DOUT_TEMP[6]~0_combout\);

\INST8|WideOr2~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST8|WideOr2~0_combout\ = (!\INST8|current_state.S4~q\ & (!\INST8|current_state.S5~q\ & (!\INST8|current_state.S2~q\ & !\INST8|current_state.S3~q\)))
...
-- Equation(s):
-- \INST8|WideOr5~0_combout\ = (\INST8|current_state.S12~q\) # ((\INST8|current_state.S13~q\) # ((\INST8|current_state.S10~q\) # (\INST8|current_state.S11~q\)))
...
-- Equation(s):
-- \INST8|WideOr9~0_combout\ = (\INST8|current_state.S4~q\) # ((\INST8|current_state.S12~q\) # ((\INST8|current_state.S6~q\) # (\INST8|current_state.S14~q\)))
...
-- Equation(s):
-- \INST8|WideOr7~0_combout\ = (\INST8|current_state.S0~q\ & (!\INST8|current_state.S2~q\ & (!\INST8|current_state.S10~q\ & !\INST8|current_state.S8~q\)))
...
-- Equation(s):
-- \INST8|WideOr8~0_combout\ = (\INST8|current_state.S12~q\) # ((\INST8|current_state.S13~q\) # ((\INST8|current_state.S1~q\) # (!\INST8|current_state.S0~q\)))
...
-- Equation(s):
-- \INST8|WideOr8~1_combout\ = (\INST8|current_state.S4~q\) # ((\INST8|current_state.S5~q\) # ((\INST8|current_state.S8~q\) # (\INST8|current_state.S9~q\)))
...
-- Equation(s):
-- \INST8|WideOr8~combout\ = (\INST8|WideOr8~0_combout\) # (\INST8|WideOr8~1_combout\)
...
-- Equation(s):
-- \INST8|WideOr7~1_combout\ = (\INST8|current_state.S3~q\) # ((\INST8|current_state.S11~q\) # ((\INST8|current_state.S1~q\) # (\INST8|current_state.S9~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST8|WideOr7~1_combout\,
	datad => \INST8|WideOr7~0_combout\,
	combout => \INST8|WideOr7~combout\);

\INST8|WideOr6\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST8|WideOr6~combout\ = (\INST8|current_state.S1~q\) # (((!\INST8|NS_A~0_combout\) # (!\INST8|current_state.S0~q\)) # (!\INST8|WideOr2~0_combout\))
...
\INST8|EW_A\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST8|EW_A~combout\ = (\INST8|current_state.S14~q\) # (\INST8|current_state.S15~q\)
...
PORT MAP (
	dataa => \INST8|current_state.S14~q\,
	datab => \INST8|current_state.S15~q\,
	combout => \INST8|EW_A~combout\);

\INST8|Selector3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST8|Selector3~0_combout\ = (\INST8|WideOr5~0_combout\) # ((\INST5|blink_sig~q\ & ((\INST8|current_state.S8~q\) # (\INST8|current_state.S9~q\))))
...
-- Equation(s):
-- \INST8|Selector2~0_combout\ = ((\INST5|blink_sig~q\ & ((\INST8|current_state.S1~q\) # (!\INST8|current_state.S0~q\)))) # (!\INST8|WideOr2~0_combout\)
...
-- Equation(s):
-- \INST9|DOUT[0]~0_combout\ = \INST8|WideOr6~combout\ $ (\INST9|clk_proc:COUNT[10]~q\)
...
-- Equation(s):
-- \INST9|DOUT[3]~1_combout\ = (\INST9|clk_proc:COUNT[10]~q\ & (\INST8|Selector2~0_combout\)) # (!\INST9|clk_proc:COUNT[10]~q\ & ((\INST8|Selector3~0_combout\)))
...
PORT MAP (
	...
	datab => \INST8|Selector3~0_combout\,
	datad => \INST9|clk_proc:COUNT[10]~q\,
...
ww_sm_clken_wv <= \sm_clken_wv~output_o\;

ww_blink_sig_wv <= \blink_sig_wv~output_o\;
